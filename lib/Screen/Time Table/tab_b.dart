...
class _TabBState extends State<TabB> {
  ...
  Widget build(BuildContext context) {
    ...
    List<List> subj = [
      ["DAA", "eCD/CSDL", "AI-ML", "MT LAB", "MT LAB", "NUES", "MP-III"],
      ["DAA", "eCD/CSDL", "SPM", "MT", "AI-ML LAB", "AI-ML LAB", "MP-III"],
      ["NUES", "eCD/CSDL", "SPM", "DAA LAB", "DAA LAB", "AI-ML", "MP-III"],
      ["DAA", "SPM LAB", "SPM LAB", "SPM", "LIB", "MT", "AI-ML"],
      ["SPM", "eCD/CSDL", "DAA", "MT", "AI-ML", "MP-III", "MP-III"],
    ];
    Map<String, String> teacher = {
      "DAA": "Rahul Mishra",
      "DAA LAB": "Rahul Mishra",
